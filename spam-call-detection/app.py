...
performance_prompt = '''
Tell whether the call was a spam call or not. In technical terms and in proer formatting write evidence whty you think so.
And then at the end mention the accuracy of this being a fraud call.          
'''
...
st.title('Fraud Call Detection AI')
